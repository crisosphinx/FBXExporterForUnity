...
#### Originally developed by KellanHiggins : [Original FBXExporter](https://github.com/KellanHiggins/UnityFBXExporter)
...
----------------
 - Download the project ([RECOMMENDED : unitypackage](https://github.com/crisosphinx/FBXExporterForUnity/raw/master/FBXExporterForUnity.unitypackage))
 - Do one of the following:
   + Drop all files into the Assets directory, or
   + Unzip the *FBXExporterForUnity.unitypackage* into your project (recommended, as it is easier and contains less steps),
